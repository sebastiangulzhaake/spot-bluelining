...
def gaze_and_align(config):
    ...
    sdk = bosdyn.client.create_standard_sdk('GazeAndAlign')
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        # We specify an orientation for the body in hand's frame.
        angle = 0

        body_pose_in_hand = math_helpers.SE2Pose(x=body_x, y=body_y, angle=angle)
        body_pose_in_vision = vision_T_hand * body_pose_in_hand
