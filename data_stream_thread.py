...
class DataStreamThread(threading.Thread):
    ...
    # No filtering, but kept function name
    ...
    # IP and PORT are set in main program. 
    def leica(self):
    ...
    # Data stream method for use with the Krypton tracking system
    # IP and PORT are set in main program. 
    def krypton(self):
